...
public final class InfluxDbProvider implements NoSqlProvider<InfluxDbConnection> {
	...
	public InfluxDbProvider(final String databaseName, final String seriesName, final String url, final String username,
			final String password, final String transport, final Integer udpPort) {
